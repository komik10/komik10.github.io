<?php function article_2($data) {
 ...
 col-sm-2
 col-xs-1">
    <div class="bd-layoutcolumn-36"><div class="bd-vertical-align-wrapper"><img class="bd-imagestyles bd-imagelink-2   " src="<?php echo JURI::base() . 'templates/' . JFactory::getApplication()->getTemplate(); ?>/images/designer/2a5f6ceeedece15f12463c15940d3c1d_hand.png"></div></div>
</div>
...
<div class=" bd-extendedpostimage-1">
    ...
    <a href="<?php echo $image['link']; ?>">
        <?php endif; ?>
        <img src="<?php echo $image['image']; ?>" alt="<?php echo $image['alt']; ?>" class=" bd-imagestyles-17"/>
        <?php if (isset($image['link']) && $image['link'] !== '') : ?>
    </a>
    <?php endif; ?>
